...
func shouldEmitCLIInvocation(cmd *cobra.Command) bool {
	...
	case "ao daemon", "ao start", "ao completion", "ao help", "ao pty-host", "ao agent-process", "ao agent-process supervise", "ao review supervise", "ao arbiter", "ao arbiter supervise", "ao recovery", "ao recovery supervise":
		return false
	default:
		return true
	}
