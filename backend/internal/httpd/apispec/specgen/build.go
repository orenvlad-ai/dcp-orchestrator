...
var schemaNames = map[string]string{
	...
	"ControllersReviewProcessExitInput": "ReviewProcessExitInput",
...
func reviewOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/reviews/process-exit", id: "reportReviewProcessExit", tag: "reviews",
			summary:    "Record a supervised reviewer process exit",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.ReviewProcessExitInput{},
			resps: []respUnit{
				{http.StatusOK, controllers.ReviewRunResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusUnprocessableEntity, envelope.APIError{}},
