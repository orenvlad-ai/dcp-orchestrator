...
func (q *Queries) CountExactDCPCard12ColdStartToolPathRecovery(ctx context.Context) (int64, error) {
	row := q.db.QueryRowContext(ctx, countExactDCPCard12ColdStartToolPathRecovery)
	var count int64
	err := row.Scan(&count)
	return count, err
}
