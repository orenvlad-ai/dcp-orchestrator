...
control_plane_commit='4dfff558ac425080d62bd6fe2fb13b573ef50661'
...
source_gates() {
	...
	printf '%s\n%s\n%s\n%s\n%s\n%s\n%s\n' "$terminal_merge_migration" "$admission_migration" "$recovered_incident_migration" "$arbiter_migration" "$arbiter_prelaunch_recovery_migration" "$arbiter_schema_recovery_migration" "$arbiter_successor_migration" > "${TMPDIR:-/tmp}/dcp-authorized-migrations.$$"
