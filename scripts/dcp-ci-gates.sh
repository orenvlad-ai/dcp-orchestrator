...
control_plane_commit='0b12727a99ddc448b5d19c252615b7bf13bd7113'
...
source_gates() {
	...
	printf '%s\n%s\n%s\n%s\n' "$terminal_merge_migration" "$admission_migration" "$recovered_incident_migration" "$arbiter_migration" > "${TMPDIR:-/tmp}/dcp-authorized-migrations.$$"
	...
	grep -Fq 'rollout_budget.limit_tokens=16384' backend/internal/dcpterminalmerge/arbiter_launcher.go || fail 'I13 Stage 2 hard rollout budget is absent'
