...
control_plane_commit='2a174899ae72bf1db548c3b2f172d963488191f1'
...
source_gates() {
	...
	printf '%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n' "$terminal_merge_migration" "$admission_migration" "$recovered_incident_migration" "$arbiter_migration" "$arbiter_prelaunch_recovery_migration" "$arbiter_schema_recovery_migration" "$arbiter_successor_migration" "$arbiter_successor_validation_recovery_migration" > "${TMPDIR:-/tmp}/dcp-authorized-migrations.$$"
