...
control_plane_commit='90f258a3943b824a31481bfaf132b06b442891f7'
...
source_gates() {
	...
	printf '%s\n%s\n%s\n' "$terminal_merge_migration" "$admission_migration" "$recovered_incident_migration" > "${TMPDIR:-/tmp}/dcp-authorized-migrations.$$"
