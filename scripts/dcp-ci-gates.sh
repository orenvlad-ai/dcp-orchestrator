...
control_plane_commit='3f3a3bb2c2e951cbf7a34da75d3cc3f09d906001'
...
source_gates() {
	...
	printf '%s\n%s\n%s\n%s\n%s\n%s\n' "$terminal_merge_migration" "$admission_migration" "$recovered_incident_migration" "$arbiter_migration" "$arbiter_prelaunch_recovery_migration" "$arbiter_schema_recovery_migration" > "${TMPDIR:-/tmp}/dcp-authorized-migrations.$$"
