			...
			sessions: (sessionsData?.sessions ?? [])
				...
				.map((session) => {
					...
					return {
						...
						dcpPolicyProfile: session.dcpPolicyProfile,
						dcpPolicyReleasePhase: session.dcpPolicyReleasePhase,
						dcpPolicyReadmissionStatus: session.dcpPolicyReadmissionStatus,
						...
						dcpArbiterCohort: session.dcpArbiterCohort,
						dcpArbiterActionStatus: session.dcpArbiterActionStatus,
						dcpHumanGateQuestion: session.dcpHumanGateQuestion,
